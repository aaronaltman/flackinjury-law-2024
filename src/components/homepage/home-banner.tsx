...
export default function HomeBanner() {
  return (
    <div className="flex flex-col md:flex-row justify-center items-center px-4 py-1 shadow-lg bg-gradient-to-r from-rose-800 via-rose-600 to-rose-900 text-zinc-100 font-semibold">
